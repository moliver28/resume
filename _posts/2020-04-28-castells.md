...
<div id = "space-of-flows" class = "row">
  <div class="col-md-3">                    
  <img src="{{ site.baseurl }}/assets/img/spaceofflows.jpeg" style="float:left; margin:0px 30px 10px 10px;"> 
  </div>
  <div class = "col-md-8">
<p>
...
<div id = "timeless-time" class = "row">
  <div class="col-md-3">                    
  <img src="{{ site.baseurl }}/assets/img/Dali_Clocks.jpeg" style="float:left; margin:0px 30px 10px 10px;"> 
  </div>
  <div class = "col-md-8">
<p>
  <h4>Timeless Time</h4>
